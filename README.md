...
### **2. CYP2C19 กับ การเปิด-ปิดของช่องทางเข้าสารตั้งต้น (Substrate Access Channel)**
   ...
   - **การเปลี่ยนแปลงโครงสร้าง** อัลลีล CYP2C19*2 เกิดการกลายพันธุ์ที่ทำให้เกิดรหัสหยุดก่อนกำหนด (Splicing defect) ส่งผลให้โครงสร้างสามมิติขาดหายไปครึ่งหนึ่งและสูญเสียฟังก์ชันโดยสิ้นเชิง ในทางกลับกัน CYP2C19*17 มีการเพิ่มการ

แสดงออกของยีน ทำให้ช่องเร่งปฏิกิริยาเปิดรับสารได้มากกว่าปกติ
