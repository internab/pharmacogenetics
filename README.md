...
**1.การจัดการกลุ่มยีนบกพร่องปานกลาง (Intermediate Metabolizer: IM)**
   - FDA Label (2022): มุ่งเน้นและออกคำเตือนรุนแรงที่สุด (Boxed Warning) ไปที่กลุ่ม Poor Metabolizer (PM) (ผู้ที่มียีนทำงานไม่ได้เลยทั้ง 2 ข้าง) โดยระบุให้พิจารณาเปลี่ยนไปใช้ยาตัวอื่น ส่วนกลุ่ม Intermediate Metabolizer (มียีนปกติ 1 ข้าง ยีนบกพร่อง 1 ข้าง) เอกสารของ FDA มีการระบุข้อมูลทางเภสัชจลนศาสตร์ว่าได้ผลลดลงเช่นกันในหน้า 14 (ตารางที่ 3) แต่ไม่ได้ยกระดับคำเตือนให้เข้มงวดเท่ากลุ่ม PM ในหน้าแรก
   - CPIC Guideline (2022): มีคำแนะนำที่ "**Strong**" กว่า โดยแนะนำให้หลีกเลี่ยงการใช้ยา Clopidogrel และเปลี่ยนไปใช้ยาทางเลือกอื่น (เช่น Prasugrel หรือ Ticagrelor) ทั้งในกลุ่ม Poor และกลุ่ม Intermediate Metabolizer เนื่องจากมีหลักฐานเชิงประจักษ์ชัดเจนว่าผู้ป่วยกลุ่ม IM ก็มีความเสี่ยงต่อการเกิดภาวะหัวใจวายซ้ำหรือลิ่มเลือดอุดตันในหลอดเลือดฝอยสูงขึ้นอย่างมีนัยสำคัญเช่นกัน

**2.คำแนะนำสำหรับกลุ่มยีนทำงานเร็วพิเศษ (Ultrarapid / Rapid Metabolizer)**
   
   - FDA Label (2022): ไม่ได้ระบุแนวทางปฏิบัติเฉพาะเจาะจงสำหรับผู้ป่วยกลุ่มยีนเด่นเหล่านี้เอาไว้ในส่วนการปรับขนาดยา
   - CPIC Guideline (2022): ระบุคำแนะนำระดับ Strong ชัดเจนว่าสำหรับกลุ่ม Ultrarapid ($*17/*17$) และ Rapid ($*1/*17$) สามารถใช้ยา Clopidogrel ในขนาดวันละ 75 mg ตามมาตรฐานได้เลย เพราะแม้การเปลี่ยนสภาพยาจะสูงขึ้นเล็กน้อย แต่จากฐานข้อมูลทางคลินิกพบว่าไม่ได้เพิ่มความเสี่ยงต่อการเลือดออกอย่างมีนัยสำคัญเมื่อเทียบกับกลุ่มยีนปกติ (Normal)

**3.ขอบเขตของข้อบ่งชี้โรค (Clinical Indications)**

   - FDA Label (2022): ข้อจำกัดหรือคำเตือนเรื่องยีน CYP2C19 ในฉบับของ FDA จะเน้นหนักไปที่ผู้ป่วยกลุ่มอาการโรคหัวใจขาดเลือดเฉียบพลัน (Acute Coronary Syndrome: ACS) ที่เข้ารับการทำหัตถการขยายหลอดเลือดหัวใจ (PCI) เป็นหลัก
   - CPIC Guideline (2022): ขยายคำแนะนำ (Expanded Indications) ครอบคลุมกว้างกว่า โดยระบุว่าควรใช้ผลตรวจยีน CYP2C19 มานำร่องการเลือกใช้ยาต้านเกล็ดเลือดในโรคระบบหลอดเลือดสมองด้วย เช่น ผู้ป่วยที่มีภาวะสมองขาดเลือดเฉียบพลัน (Acute Ischemic Stroke) หรือภาวะสมองขาดเลือดชั่วคราว (Transient Ischemic Attack: TIA) 

**4.การประยุกต์ใช้ในผู้ป่วยเด็ก (Pediatric Population)**
   
   - FDA Label (2022): ระบุชัดเจนในหน้า 9 (Section 8.4) ว่า "ยังไม่มีการรับรองความปลอดภัยและประสิทธิภาพในเด็ก" และการทดลองทางคลินิกในเด็ก (CLARINET) ไม่พบประโยชน์
   - CPIC Guideline (2022): เนื่องจาก CPIC อิงตามหลักเภสัชพันธุศาสตร์เชิงลึก จึงระบุว่า เนื่องจากระบบเอนไซม์ CYP2C19 ในทารกจะเจริญเติบโตเต็มที่หลังอายุ 2-3 เดือนเป็นต้นไป ดังนั้น ในกรณีที่จำเป็น แพทย์สามารถอนุมาน (Extrapolate) แนวทางการปรับยาตามยีนของ CPIC ไปใช้กับผู้ป่วยเด็กได้

**5.วัตถุประสงค์และการนำไปใช้ในหน้างาน (Regulatory vs Clinical Action)**
   
   - FDA Label (2022): ออกกฎในเชิง Regulatory (การกำกับดูแลและความปลอดภัย) เพื่อเตือนให้แพทย์ตระหนักถึงข้อจำกัดสูงสุดของยาและป้องกันการฟ้องร้องทางกฎหมาย โดยระบุแค่ว่า "มีชุดตรวจให้บริการ" (Tests are available) แต่ไม่ได้ลงรายละเอียดวิธีปรับยาในทุกกรณี
   - CPIC Guideline (2022): ออกแบบมาเพื่อให้เป็น Clinical Decision Support (คู่มือปฏิบัติหน้างานของแพทย์) โดยจะแปลผลจีโนไทป์ (เช่น $*1/*2, *2/*2, *1/*17$) ออกมาเป็นตารางคำแนะนำการสั่งยาที่ชัดเจน (Actionable recommendations) ว่าต้องเพิ่มขนาดหรือเปลี่ยนยาอย่างไรในชีวิตจริง

**ตารางสรุปเปรียบเทียบคำแนะนำการสั่งยา (Therapeutic Action)**

| กลุ่มฟีโนไทป์ของยีน (CYP2C19) | คำแนะนำจาก FDA Label (2022) | คำแนะนำจาก CPIC Guideline (2022) | 
| :--- | :--- | :--- |
| Normal (*1/*1) | ให้ขนาดมาตรฐาน 75 mg | ให้ขนาดมาตรฐาน 75 mg (Strong) | 
| Rapid / Ultrarapid | ไม่ได้เน้นย้ำปฏิบัติการเฉพาะ | ให้ขนาดมาตรฐาน 75 mg (Strong) | 
| Intermediate (IM) | ระบุว่ายาได้ผลลดลง แต่คำเตือนไม่รุนแรงเท่า PM | หลีกเลี่ยง Clopidogrel / ให้เปลี่ยนเป็น Prasugrel หรือ Ticagrelor (Strong) |
| Poor (PM) | พิจารณาเปลี่ยนไปใช้ยาตัวอื่น (Boxed Warning) | หลีกเลี่ยง Clopidogrel / ให้เปลี่ยนเป็น Prasugrel หรือ Ticagrelor (Strong) |
...
ยาต้านเศร้ากลุ่มยับยั้งการดูดซึมเซโรโทนิน (**Serotonin reuptake inhibitor antidepressants**) เป็นยาหลักที่ใช้ในการรักษาโรคซึมเศร้า โรควิตกกังวล และโรคย้ำคิดย้ำทำ ซึ่งแบ่งออกเป็น:
* **SSRIs:** เช่น Citalopram, Escitalopram, Fluoxetine, Fluvoxamine, Paroxetine และ Sertraline
* **SNRIs:** เช่น Desvenlafaxine, Duloxetine, Levomilnacipran, Milnacipran และ Venlafaxine
* **Serotonin modulators (SSRI-like):** เช่น Vilazodone และ Vortioxetine

> 💡 **กลไกการออกฤทธิ์และผลข้างเคียง:** ยาเหล่านี้ยับยั้งการดูดซึมเซโรโทนินกลับโดยตัวขนส่งเซโรโทนิน (SERT) แต่อาจนำไปสู่ผลข้างเคียง เช่น อาการกระสับกระส่าย ปวดศีรษะ อาการทางระบบทางเดินอาหาร และความเสี่ยงร้ายแรงทางหัวใจอย่างภาวะ **QT Prolongation**
> 
> ความแปรผันทางพันธุกรรมในเอนไซม์ **CYP2D6** และ **CYP2C19** มีอิทธิพลอย่างมากต่อระดับยาในกระแสเลือด ขนาดยาที่เหมาะสม ประสิทธิภาพ และความทนทานต่อยาของผู้ป่วยแต่ละบุคคล
...
**(ก) ยา Paroxetine**
 | Phenotype |	คำแนะนำในการรักษา |	ข้อควรพิจารณา |
 | :--- | :--- | :--- |
 | **CYP2D6 ultrarapid metabolizer** |	เลือกยาทางเลือกที่ไม่ถูกเมตาบอไลซ์โดยเอนไซม์ CYP2D6 เป็นหลัก | ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อเลือกวิธีการรักษาทางเลือก |
 | **CYP2D6 normal metabolize** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | - |
 | **CYP2D6 intermediate metabolizer** | ควรพิจารณาเริ่มใช้ยาในขนาดที่ต่ำกว่าและค่อยๆ ปรับขนาดยาอย่างช้าๆ เมื่อเทียบกับผู้ที่มีการเผาผลาญยาปกติ | ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อปรับขนาดยาหรือเลือกวิธีการรักษาอื่น |
 | **CYP2D6 poor metabolizer** | พิจารณาการลดขนาดยาเริ่มต้นที่แนะนำลง 50% ปรับขนาดยาอย่างช้าๆ และลดขนาดยาบำรุงรักษาลง 50% เมื่อเทียบกับผู้ที่มีการเผาผลาญยาปกติ | ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อปรับขนาดยาหรือเลือกวิธีการรักษาอื่น |

>[!WARNING]
>**ระวังปฏิกิริยา "ยับยั้งตัวเอง" (Autoinhibition) ของ Paroxetine**:
>ยา Paroxetine เป็นทั้งสารตั้งต้น (Substrate) และตัวยับยั้ง (Inhibitor) ที่แรงของ CYP2D6 ดังนั้น ผู้ป่วยที่เป็นกลุ่ม Normal หรือ Intermediate เมื่อกินยาไปสักพัก ยาจะไปบล็อกเอนไซม์ตัวเอง ทำให้ร่างกายเปลี่ยนสภาพเสมือนกลายเป็นกลุ่ม Poor Metabolizer (PM) ชั่วคราว ส่งผลให้ระดับยาในเลือดพุ่งสูงขึ้นกว่าที่คิดในระยะยาว

**(b) ยา Fluvoxamine**

 | Phenotype |	คำแนะนำในการรักษา |	ข้อควรพิจารณา |
 | :--- | :--- | :--- |
 | **CYP2D6 ultrarapid metabolizer** | ไม่มีข้อแนะนำเนื่องจากขาดหลักฐาน | - |
 | **CYP2D6 normal metabolize** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | - |
 | **CYP2D6 intermediate metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | - |
 | **CYP2D6 poor metabolizer** | ควรพิจารณาขนาดยาเริ่มต้นที่ต่ำกว่า 25-50% และค่อยๆ ปรับขนาดยาให้ช้าลงเมื่อเทียบกับผู้ที่มีการเผาผลาญยาปกติ หรือพิจารณาใช้ยาต้านเศร้าทางเลือกอื่นที่เหมาะสมทางคลินิกซึ่งไม่ได้ถูกเผาผลาญโดยเอนไซม์ CYP2D6 เป็นหลัก | ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อปรับขนาดยาหรือเลือกวิธีการรักษาอื่น |

**(C) ยา Venlafaxine**

 | Phenotype |	คำแนะนำในการรักษา |	ข้อควรพิจารณา |
 | :--- | :--- | :--- |
 | **CYP2D6 ultrarapid metabolizer** | ไม่แนะนำให้ดำเนินการใดๆ โดยอิงตามจีโนไทป์สำหรับยาเวนลาแฟกซีน เนื่องจากมีหลักฐานน้อยมากเกี่ยวกับผลกระทบต่อประสิทธิภาพหรือผลข้างเคียง	 | - |	
 | **CYP2D6 normal metabolize** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | - |
 | **CYP2D6 intermediate metabolizer** | ไม่แนะนำให้ดำเนินการใดๆ โดยอิงตามจีโนไทป์สำหรับยาเวนลาแฟกซีน เนื่องจากมีหลักฐานน้อยมากเกี่ยวกับผลกระทบต่อประสิทธิภาพหรือผลข้างเคียง | - |
 | **CYP2D6 poor metabolizer** | พิจารณาใช้ยาต้านอาการซึมเศร้าทางเลือกอื่นที่เหมาะสมทางคลินิก ซึ่งไม่ได้ถูกเมตาบอไลซ์โดยเอนไซม์ CYP2D6 เป็นหลัก | ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อปรับขนาดยาหรือเลือกวิธีการรักษาอื่น |

>[!WARNING]
>**ผลกระทบต่อยาเวนลาแฟกซีน (Venlafaxine)**:
>แม้ว่ากลุ่ม Poor Metabolizer (PM) จะมีคำแนะนำให้เลี่ยงยา Venlafaxine (เพราะเสี่ยงต่อผลข้างเคียงสูง) แต่ในกลุ่ม Ultrarapid (UM) ทาง CPIC ไม่ได้แนะนำให้ปรับขนาดเพิ่ม เนื่องจากร่างกายจะเปลี่ยน Venlafaxine ไปเป็นสารออกฤทธิ์อีกตัวที่ชื่อ O-desmethylvenlafaxine (หรือยา Desvenlafaxine) ได้เร็วขึ้น ซึ่งสารตัวนี้ก็ยังออกฤทธิ์ต้านเศร้าได้ดีอยู่ จึงไม่เสียประสิทธิภาพในการรักษา

**(d) ยา Vortioxetine**

 | Phenotype |	คำแนะนำในการรักษา |	ข้อควรพิจารณา |
 | :--- | :--- | :--- |
 | **CYP2D6 ultrarapid metabolizer** | เลือกใช้ยาทางเลือกที่ไม่ถูกเมตาบอไลซ์โดยเอนไซม์ CYP2D6 เป็นหลัก หากจำเป็นต้องใช้vortioxetine ให้เริ่มการรักษาด้วยขนาดยาเริ่มต้นมาตรฐาน และปรับขนาดยาเพื่อคงการรักษาตามประสิทธิภาพและผลข้างเคียง การเพิ่มขนาดยาเพื่อคงการรักษาเป้าหมายขึ้น 50% หรือมากกว่านั้นอาจจำเป็นเพื่อให้ได้ผลลัพธ์ที่ดีขึ้น | ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อเลือกวิธีการรักษาทางเลือก |
 | **CYP2D6 normal metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | - |
 | **CYP2D6 intermediate metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | - |
 | **CYP2D6 poor metabolizer** | เริ่มต้นด้วยขนาดยา 50% ของขนาดยาเริ่มต้น (เช่น 5 มิลลิกรัม) และค่อยๆ เพิ่มขนาดยาจนถึงขนาดยาสูงสุดที่แนะนำคือ 10 มิลลิกรัม หรือพิจารณาใช้ยาต้านอาการซึมเศร้าทางเลือกอื่นที่เหมาะสมทางคลินิกซึ่งไม่ได้ถูกเมตาบอไลซ์โดยเอนไซม์ CYP2D6 เป็นหลัก |  ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อเลือกวิธีการรักษาทางเลือก |

 ### คำแนะนำในการให้ยาต้านอาการซึมเศร้าตามลักษณะฟีโนไทป์ของ CYP2C19

 **(ก) ยา Citalopram และ Escitalopram**

 | Phenotype |	คำแนะนำในการรักษา |	ข้อควรพิจารณา |
 | :--- | :--- | :--- |
 | **CYP2C19 ultrarapid metabolizer** | พิจารณาใช้ยาต้านเศร้าทางเลือกอื่นที่เหมาะสมทางคลินิกซึ่งไม่ได้ถูกเมตาบอไลซ์โดยเอนไซม์ CYP2C19 เป็นหลัก หากยา citalopram หรือ escitalopram เหมาะสมทางคลินิก และไม่ได้ผลดีเพียงพอในขนาดยาบำรุงรักษามาตรฐาน ให้พิจารณาปรับขนาดยาบำรุงรักษาให้สูงขึ้น | ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อปรับขนาดยาหรือเลือกวิธีการรักษาอื่น |
 | **CYP2C19 rapid metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ หากผู้ป่วยไม่ตอบสนองต่อขนาดยาบำรุงรักษาที่แนะนำอย่างเพียงพอ ให้พิจารณาปรับขนาดยาบำรุงรักษาให้สูงขึ้น หรือเปลี่ยนไปใช้ยาต้านเศร้าทางเลือกอื่นที่เหมาะสมทางคลินิกซึ่งไม่ได้ถูกเมตาบอไลซ์โดยเอนไซม์ CYP2C19 เป็นหลัก	| ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อปรับขนาดยาหรือเลือกวิธีการรักษาอื่น |
 | **CYP2C19 normal metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | - |
 | **CYP2C19 intermediate metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ พิจารณาปรับขนาดยาอย่างช้าๆ และขนาดยาบำรุงรักษาที่ต่ำกว่าผู้ที่มีการเผาผลาญปกติ | ควรพิจารณาปฏิกิริยาระหว่างยาและลักษณะเฉพาะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) เมื่อปรับขนาดยา |
 | **CYP2C19 poor metabolizer** | พิจารณาใช้ยาต้านเศร้าที่เหมาะสมทางคลินิกซึ่งไม่ได้ถูกเมตาบอไลซ์โดยเอนไซม์ CYP2C19 เป็นหลัก หากยา citalopram หรือ escitalopram เหมาะสมทางคลินิก ให้พิจารณาใช้ขนาดยาเริ่มต้นที่ต่ำกว่า ปรับขนาดยาอย่างช้าๆ และลดขนาดยาบำรุงรักษามาตรฐานลง 50% เมื่อเทียบกับผู้ที่มีการเผาผลาญยาปกติ	 | ตามคำเตือนขององค์การอาหารและยา (FDA) ยาcitalopram ขนาด 20 มิลลิกรัมต่อวัน เป็นขนาดยาสูงสุดที่แนะนำในผู้ที่มีการเผาผลาญยา CYP2C19 ต่ำ เนื่องจากมีความเสี่ยงต่อภาวะ QT prolongation นอกจากนี้ ฉลากผลิตภัณฑ์ของ FDA ยังเตือนเพิ่มเติมว่า ควรจำกัดขนาดยาcitalopramไว้ที่ 20 มิลลิกรัมต่อวันในผู้ป่วยที่มีภาวะตับบกพร่อง ผู้ที่กำลังใช้ยาที่ยับยั้งเอนไซม์ CYP2C19 และผู้ป่วยที่มีอายุมากกว่า 60 ปี |

>[!NOTE]
>แม้ว่า FDA จะไม่ได้ระบุขีดจำกัดโดสของ Escitalopram ไว้ชัดเจนเหมือน Citalopram แต่เนื่องจากโครงสร้างยาคล้ายกัน จึงควรระวังความเสี่ยงต่อภาวะ QT prolongation ในกลุ่ม PM เช่นกัน

 **(b) ยา Sertraline**

 | Phenotype |	คำแนะนำในการรักษา |	ข้อควรพิจารณา |
 | :--- | :--- | :--- |
 | **CYP2C19 ultrarapid metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | สถานะการเผาผลาญของเอนไซม์ CYP2B6 ปฏิกิริยาระหว่างยา และลักษณะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) ควรนำมาพิจารณาด้วยเช่นกัน |
 | **CYP2C19 rapid metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | สถานะการเผาผลาญของเอนไซม์ CYP2B6 ปฏิกิริยาระหว่างยา และลักษณะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) ควรนำมาพิจารณาด้วยเช่นกัน |
 | **CYP2C19 normal metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ | สถานะการเผาผลาญของเอนไซม์ CYP2B6 ปฏิกิริยาระหว่างยา และลักษณะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) ควรนำมาพิจารณาด้วยเช่นกัน |
 | **CYP2C19 intermediate metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำ พิจารณาปรับขนาดยาอย่างช้าๆ และใช้ขนาดยาบำรุงรักษาที่ต่ำกว่าสำหรับผู้ที่มีการเผาผลาญ CYP2C19 ปกติ | สถานะการเผาผลาญของเอนไซม์ CYP2B6 ปฏิกิริยาระหว่างยา และลักษณะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) ควรนำมาพิจารณาเมื่อปรับขนาดยาหรือเลือกการรักษาทางเลือกอื่น |
 | **CYP2C19 poor metabolizer** | พิจารณาการเริ่มใช้ยาในขนาดที่ต่ำกว่า การปรับขนาดยาอย่างช้าๆ และลดขนาดยาบำรุงรักษามาตรฐานลง 50% เมื่อเทียบกับผู้ที่มีการเผาผลาญ CYP2C19 ปกติ หรือเลือกใช้ยาต้านเศร้าทางเลือกอื่นที่เหมาะสมทางคลินิกซึ่งไม่ได้ถูกเผาผลาญโดย CYP2C19 เป็นหลัก | สถานะการเผาผลาญของเอนไซม์ CYP2B6 ปฏิกิริยาระหว่างยา และลักษณะอื่นๆ ของผู้ป่วย (เช่น อายุ การทำงานของไต การทำงานของตับ) ควรนำมาพิจารณาเมื่อปรับขนาดยาหรือเลือกการรักษาทางเลือกอื่น |

### คำแนะนำในการให้ยา Sertraline ตามฟีโนไทป์ CYP2B6

| Phenotype | คำแนะนำในการรักษา | ข้อควรพิจารณา |
| :--- | :--- | :--- |
| **Ultrarapid metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำตามมาตรฐาน | ไม่แนะนำให้ปรับเพิ่มขนาดยาล่วงหน้า แม้ร่างกายจะเผาผลาญยาได้เร็วขึ้นเล็กน้อย |
| **Rapid metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำตามมาตรฐาน | ยาถูกเผาผลาญเพิ่มขึ้นเล็กน้อยแต่ไม่มีผลต่อการรักษา |
| **Normal metabolizer** | เริ่มการรักษาด้วยขนาดยาเริ่มต้นที่แนะนำตามมาตรฐาน | กระบวนการเผาผลาญยาเป็นไปตามปกติ |
| **Intermediate metabolizer** | เริ่มต้นด้วยขนาดแนะนำ แต่พิจารณาปรับยาอย่างช้าๆ และใช้ขนาดยาบำรุงรักษาที่ต่ำลง | อัตราการเผาผลาญยาลดลงเล็กน้อย ทำให้ระดับยาในเลือดอาจสูงขึ้นกว่าปกติ |
| **Poor metabolizer** | พิจารณาเริ่มใช้ยาในขนาดที่ต่ำกว่า, ปรับยาอย่างช้าๆ และ**ลดขนาดยาบำรุงรักษามาตรฐานลง 25%** หรือเปลี่ยนยา | ⚠️ การเผาผลาญลดลงอย่างมาก ระดับยาในพลาสมาจะสูงขึ้นชัดเจน เสี่ยงต่อการเกิดผลข้างเคียงสูง (ควรพิจารณาสถานะยีน CYP2C19 ร่วมด้วย) |
>[!NOTE]
>ยา Sertraline เป็นยาตัวเดียวในกลุ่มนี้ที่มีคำแนะนำร่วมระหว่างยีน (Multi-gene) เนื่องจากถูกเมตาบอไลซ์ผ่านทั้ง CYP2C19 และ CYP2B6 ดังนั้น ในการประเมินความปลอดภัยของผู้ป่วย หากเป็นไปได้ควรพิจารณาผลตรวจของยีน CYP2B6 ควบคู่ไปด้วย โดยเฉพาะในรายที่ตรวจพบว่าเป็นกลุ่ม CYP2C19 Intermediate หรือ Poor Metabolizer เพื่อป้องกันภาวะยาเกินขนาด


 **อ้างอิง(References)**
> Bousman, C. A., et al. (2023). Clinical Pharmacogenetics Implementation Consortium (CPIC) guideline for CYP2D6, CYP2C19, CYP2B6, SLC6A4, and HTR2A genotypes and serotonin reuptake inhibitor antidepressants. *Clinical Pharmacology & Therapeutics*, 114(1), 51–68. [https://doi.org/10.1002/cpt.2903](https://doi.org/10.1002/cpt.2903)

## Simulation: Adjust antidepressant regimens based on metabolic profiles.

👤 **โปรไฟล์ผู้ป่วยจำลอง (Mock Patient Profile)**

  - ยาที่กำลังได้รับ: Escitalopram 10 มิลลิกรัม วันละ 1 ครั้ง (ขนาดยาเริ่มต้นมาตรฐานสำหรับโรคซึมเศร้า)
  - ผลตรวจทางพันธุกรรม (Genotype): CYP2C19( *17/*17 )
  - ฟีโนไทป์ที่แปลผลได้ (Phenotype): CYP2C19 Ultrarapid Metabolizer (UM) — ผู้เผาผลาญยาเร็วมาก
  - 🔴 ผู้ป่วยรายนี้มีความเสี่ยงสูงที่จะมีระดับยาในเลือดต่ำกว่าระดับการรักษา

- **จากข้อมูลทางพันธุกรรมและยาที่ผู้ป่วยได้รับ**
  
   เนื่องจากผู้ป่วยรายนี้มี Genotype CYP2C19 *17/*17 มี phenotype แบบ Ultrarapid Metrobolizer หรือผู้เผาผลาญเร็วมาก รับประทานยา Escitalopram ซึ่งเป็น Active drug จากรายละเอียดดังกล่าวสรุปได้ว่า ในการที่ยาจะออกฤทธิ์ Escitalopram ต้องอาศัยการได้รับยาในระดับปกติเพื่อผ่านเข้าสู่สมองและยับยั้งการดูดซึมเซโรโทนินได้อย่างมีประสิทธิภาพ แต่ผู้ป่วยรายนี้ที่มีเอนไซม์ CYP2C19 เผาผลาญยาเร็วมาก ตับจะกำจัดและย่อยสลาย Escitalopram เป็นสารเมตาโบไลต์ที่มีฤทธิ์น้อยลงอย่างรวดเร็วเกินไป 
  
   ผลที่ตามมาทางคลินิก: **"การรักษาล้มเหลว"** ความเข้มข้นของยาในพลาสมาของผู้ป่วยในสภาวะคงที่มักจะลดลงต่ำกว่าระดับที่ได้ผลขั้นต่ำอย่างมีนัยสำคัญ 

- **การปรับขนาดยาตามคำแนะนำทางคลินิกจากแนวทางปฏิบัติ CPIC guideline**

  แผนการรักษาที่เหมาะสมควรได้รับการปรับเปลี่ยนดังนี้ :
> พิจารณาใช้ยาต้านเศร้าทางเลือกอื่นที่เหมาะสมทางคลินิกซึ่งไม่ได้ถูกเมตาบอไลซ์โดยเอนไซม์ CYP2C19 เป็นหลัก
